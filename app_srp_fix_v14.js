...
function _attachCaretRemember(ta){
  ...
  ta.addEventListener("blur", fn, {passive:true});
}
...
function _captureRhymeCaret(){
  try{
    ...
    if(a && a.tagName === "TEXTAREA" && (a.classList.contains("lyrics") || a.classList.contains("fullBox"))){
      _rememberCaret(a);
      ...
      lastLyricsTextarea.__rhymeSelStart = (typeof lastLyricsTextarea.selectionStart === "number") ? lastLyricsTextarea.selectionStart : lastLyricsTextarea.__lastSelStart;
...
document.addEventListener("selectionchange", () => {
  ...
  // On some mobile browsers, focus can move to the rhyme dock while the caret stays where the user placed it.
  _rememberCaret(lastLyricsTextarea);
  refreshRhymesFromActive();
});
