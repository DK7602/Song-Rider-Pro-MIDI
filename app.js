...
// -------- Full-view "current line" highlighter (matches BSP feel) --------
function ensureFullViewAutoHighlight(){
  ...
  if(!hl){
    ...
    hl.style.border = "2px solid rgba(255,213,74,.95)";
    hl.style.boxShadow = "0 0 0 4px rgba(255,213,74,.22)";
    hl.style.background = "rgba(255,213,74,.16)";
