...
if(el.capoInput){
  ...
  if(el.notesEditor){
    ...
    el.notesEditor.addEventListener("pointerup", toggleChecklistFromPointer);
    el.notesEditor.addEventListener("mouseup", toggleChecklistFromPointer);
    el.notesEditor.addEventListener("touchend", toggleChecklistFromPointer, {passive:false});
