...
if (window.visualViewport) {
  ...
  const applyRhymeViewportUI = () => {
    ...
    if(rBtn){
      rBtn.style.transition = "bottom 140ms ease, opacity 120ms ease, transform 140ms ease";
      ...
      // Anchor with bottom instead of transform so it stays fully above the keyboard.
      rBtn.style.bottom = `${(keyboardOpen ? (overlap + 12) : 18)}px`;
    }
  };
