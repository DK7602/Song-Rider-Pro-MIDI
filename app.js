...
***********************/
{
  ...
  const BASE_BTN_BOTTOM = '12px';
  const BASE_DOCK_BOTTOM = '8px';
  const KB_BTN_BOTTOM = '12px';
  const KB_DOCK_BOTTOM = '8px';
  ...
  function applyBottomAnchors(){
    ...
    if(dock){
      ...
      forceStyle(dock, 'bottom', kbOpen ? KB_DOCK_BOTTOM : BASE_DOCK_BOTTOM);
      if(kbOpen){
        forceStyle(dock, 'max-height', '42vh');
      }else{
    ...
    if(rBtn){
      ...
      forceStyle(rBtn, 'bottom', kbOpen ? KB_BTN_BOTTOM : BASE_BTN_BOTTOM);
      if(dockShown){
